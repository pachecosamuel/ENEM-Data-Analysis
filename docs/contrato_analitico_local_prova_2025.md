...
- `local_prova_referencia.py` cobre referência/cobertura; `local_prova.py` cálculo; `local_prova_execucao.py` I/O; `local_prova_graficos.py` dois PNGs. DuckDB 256 MB/uma thread, apenas agregados para Pandas. Sem dependências adicionais.
